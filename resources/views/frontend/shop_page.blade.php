                        ...
                        <div class="row g-4">
                            <div class="col-xl-3">
                                <div class="input-group w-100 mx-auto d-flex">
                                    <form action="{{url('/search/shop')}}" method="get">
                                        @csrf
                                    ...
                                    <div class="col-md-6 col-lg-6 col-xl-4">
                                        <div class="rounded position-relative fruite-item">
                                            ...
                                            <div class="text-white bg-secondary px-3 py-1 rounded position-absolute" style="top: 10px; left: 10px;">
                                                {{ $products->category->name ?? 'No Category' }}
                                            </div>
                                            <div class="p-4 border border-secondary border-top-0 rounded-bottom">
                                                ...
                                                <div class="d-flex justify-content-between flex-lg-wrap">
                                                    ...
                                                    <form action="{{ url('/add/product/cart', $products->id) }}" method="post">
                                                        @csrf
                                                        <input style="display:none" class="quanity_dg" name="quantity" id="quantity" type="number" value="1" min="1">
                                                        <button type="submit" class="btn border border-secondary rounded-pill px-3 text-primary">
                                                            <i class="fa fa-shopping-bag me-2 text-primary"></i> Add to cart
                                                        </button>
                                                    </form>
                                                    
                                                    <a href="{{ url('/product/details', $products->id) }}" class="btn border border-secondary rounded-pill px-3 text-primary">
